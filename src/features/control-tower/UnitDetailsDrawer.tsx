...
export function UnitDetailsDrawer({
  ...
  return (
    ...
    >
      {/* Header Bar con Tabs */}
      <div className="h-14 flex items-center justify-between px-6 flex-shrink-0 bg-white border-b border-gray-100">
        ...
        {drawerState !== "minimized" ? (
          <nav className="flex gap-6 h-full items-center">
            {[
              ...
              <button
                ...
                className={`relative text-sm px-1 transition-colors h-full flex items-center gap-1.5 ${
                  activeTab === tab.id
                    ? "text-[#004ef0]"
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-[#004ef0]">
              {unit.unit}
            </span>
          </div>
        )}
